...
#define SYNTHESIS_SETTER(__TYPE__,__FIELD__) \
    void set_##__FIELD__(__TYPE__ const& l) \
		...
		SYNTHESIS_SETTER(client::con_listener, open_listener)
			...
			SYNTHESIS_SETTER(client::con_listener, ping_listener)

			SYNTHESIS_SETTER(client::con_listener, pong_listener)
...
#undef SYNTHESIS_SETTER
			...
			void clear_con_listeners()
		{
			...
			m_ping_listener = nullptr;
			m_pong_listener = nullptr;
		}
	...
	private:
		...
		client::con_listener m_ping_listener;
		client::con_listener m_pong_listener;
