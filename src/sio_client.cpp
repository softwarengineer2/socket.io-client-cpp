...
namespace sio
{
	...
	void client::set_ping_listener(con_listener const& l)
	{
		m_impl->set_ping_listener(l);
	}

	void client::set_pong_listener(con_listener const& l)
	{
		m_impl->set_pong_listener(l);
	}
